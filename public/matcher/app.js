...
// Strategy:
// 1. Prefer Web Speech API (Chrome, Edge, Safari) — live transcription.
// 2. Fallback to MediaRecorder + POST /api/transcribe (Firefox).
// Auto-sends ~1.5s after the last speech result. Click anywhere to cancel.
